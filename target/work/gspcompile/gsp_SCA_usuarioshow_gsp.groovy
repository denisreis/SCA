...
class gsp_SCA_usuarioshow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (usuarioInstance?.nome)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("usuario.nome.label"),'default':("Nome")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(usuarioInstance),'field':("nome")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
createTagBody(2, {->
...
invokeTag('link','g',38,['class':("edit"),'action':("edit"),'resource':(usuarioInstance)],3)
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource:usuarioInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(21)
})
...
public static final long LAST_MODIFIED = 1438705333453L
